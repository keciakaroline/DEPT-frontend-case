...
export function HorizontalMenuMobile({ handleClick, navBarOpen }) {
  return (
    <div className="nav-menu-for-mobile">
      <button onClick={handleClick} className="btn-menu">
        {navBarOpen ? <img src={menuX} alt="x symbol"></img> : <h6>MENU</h6>}
      </button>
    </div>
  );
}
export function NavMenuMobile({ closeMenu, navBarOpen, setNavBarOpen }) {
  return (
    <>
      {navBarOpen ? (
        <div className="big-menu-wrapper-for-mobile">
          <div className="dropdown-right-for-mobile">
            <ul>
              <li className="dropdown-right-item-for-mobile">
                <NavLink
                  exact
                  to="/"
                  className="dropdown-right-link-for-mobile"
                  onClick={() => closeMenu()}
...
export function NavMenu({ navBarOpen, closeMenu }) {
  return (
    <>
      {navBarOpen ? (
